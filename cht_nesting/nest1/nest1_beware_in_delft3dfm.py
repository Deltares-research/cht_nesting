"""Nest 1 script for nesting BEWARE within Delft3D-FM.
...
def nest1_beware_in_delft3dfm(overall: Any, detail: Any) -> None:
    """Add observation points to the overall Delft3D-FM model at BEWARE flow boundary locations.
    ...
    detail : BEWARE
        The fine BEWARE model whose flow boundary points are used as
